...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Writes text content to a specified file within the working directory (overwriting if the file exists) Creates file and parent directories if needed.",
...
def write_file(working_directory, file_path, content):
    try:
        ...
        parent_files = os.path.dirname(target_file)
